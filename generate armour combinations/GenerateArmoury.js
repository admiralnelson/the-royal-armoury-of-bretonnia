...
const RPFM_PATH = "D:/programs/rpfm shit beta/"
...
function PackTheAssets(targetPack, assetPacks) {

}

function PackToFile(fileName) {
    ...
    spawnSync(`${RPFM_PATH}/rpfm_cli.exe`, [
        '--game', 'warhammer_3', 
        'pack', 
        `create` , `--pack-path` , `${dirname}/autogenerated/@autogenerated_${fileName}.pack`, 
    ], 
    { encoding: 'utf8', stdio: 'inherit' })
    ...
    spawnSync(`${RPFM_PATH}/rpfm_cli.exe`, [
        '--game', 'warhammer_3', 
        'pack', 
        `add`, `--pack-path` , `${dirname}/autogenerated/@autogenerated_${fileName}.pack`, 
    ...
    console.log(`compiling typescript data...`)
    const results = spawnSync(`${dirname}/../build_campaign.bat`, [], 
    { encoding: 'utf8', stdio: 'inherit', cwd: `${dirname}/../` })
    if(results.status != 0) {
        throw `typescript compilation error!`
    }

    const directoryName = path.basename(path.dirname(__filename))
    console.log(`Packing compiled typescript data...`)
    spawnSync(`${RPFM_PATH}/rpfm_cli.exe`, [
        '--game', 'warhammer_3', 
        'pack', 
        `add`, `--pack-path` , `${dirname}/autogenerated/@autogenerated_${fileName}.pack`, 
        `--folder-path`, `${dirname}/../script/${directoryName}/autogenerated/campaign/mod/;script/campaign/mod`
    ], 
    { encoding: 'utf8', stdio: 'inherit' })
...
const packFileName = "massif_lord_assets.pak"
PackToFile(packFileName)
PackTheAssets(packFileName, ["@asset_grail_lords_of_bretonnia.pack"])