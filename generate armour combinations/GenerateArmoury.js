...
function GenerateTypescriptArmouryData(projectName, factions) {
    ...
    function AgentSubTypes() {
        return `[${Array.from(subtypeAgentKeys.values()).join(",")}]`
    }
    ...
    function RegisteredWeapons() {
        ...
        let entries = ``
        for (const weapon of weapons.HelmetId) {
    ...
    function RegisteredShields() {
        ...
        let entries = ``
        for (const shield of shields.HelmetId) {
...
GenerateTypescriptArmouryData("bretonnia_royal_armoury", ["wh_brt_bretonnia"])
