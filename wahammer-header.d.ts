...
interface ICampaignManager {
    ...
    */
     ...
     * @param who  target character 
     * @param ancillaryKey Ancillary key, from the ancillaries table.
     * @param removeFromPool Removes the ancillary from the character but leaves it in the pool of available ancillaries.
     * @param dontShowNotification if true no event feed events will be generated by this action
     */
    force_remove_ancillary(who: ICharacterScript, ancillaryKey: string, removeFromPool: boolean, dontShowNotification: boolean): void
    /**
